...
inline void to_yaml(
  const hand_msgs::msg::HandState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hand_msgs::msg::HandState & msg)
{
  return hand_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hand_msgs::msg::HandState>()
{
  return "hand_msgs::msg::HandState";
}

template<>
inline const char * name<hand_msgs::msg::HandState>()
{
  return "hand_msgs/msg/HandState";
}
