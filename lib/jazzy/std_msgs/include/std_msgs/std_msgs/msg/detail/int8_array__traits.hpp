...
inline void to_yaml(
  const std_msgs::msg::Int8Array & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const std_msgs::msg::Int8Array & msg)
{
  return std_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<std_msgs::msg::Int8Array>()
{
  return "std_msgs::msg::Int8Array";
}

template<>
inline const char * name<std_msgs::msg::Int8Array>()
{
  return "std_msgs/msg/Int8Array";
}
